...
mongoose
  .connect(
    "mongodb+srv://logeshkarthi782:1234567890@cluster1.pkyc5ip.mongodb.net/e-commerce?retryWrites=true&w=majority&appName=Cluster1"
  )
  .then(() => {
...
app.post("/upload", upload.single("product"), (req, res) => {
  res.json({
    success: 1,
    image_url: `https://crm-backend-0mdl.onrender.com/${req.file.filename}`,
  });
});
